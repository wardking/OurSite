                            ...
                            <div className="content system-wrap">
                                ...
                                <div className='chartsWrap clear chartsWrap1'>
                                    ...
                                    <div className='charts fl cha charts3'>
                                        ...
                                        <p className='p-title'>一拖多前台</p>
                                        <p>
                                            针对不同代理商开出不同皮肤、不同品牌的视觉前台，更灵活规划站点运营策略。
                                        </p>
                                    </div>
                                    <div className='charts fl cha charts4'>
                                        ...
                                        <p className='p-title'>试玩/带玩系统</p>
                                        <p>
                                            系统至此免费试玩、站长带玩，帮助您挖掘更多潜在优质玩家，快速提升收益。
                                        </p>
                                    </div>
                                </div>
                                <div className='chartsWrap clear'>
                                    ...
                                    <div className='charts fl cha charts8'>
                                        ...
                                        <p className='p-title'>多元合作方式</p>
                                        <p>
                                            提供现金彩票系统开站业务，或将彩票API整合到您现有系统中，合作方式灵活。
                                        </p>
                                    </div>
                                </div>
                            </div>
